...
if (carouselEl.length > 0) {
  const carousel = new Swiper('.testimonials-carousel', {
    ...
    pagination: {
      el: '.notif-pagination', // 👈 عنصر مربوط به دایره‌ها
      clickable: true,          // 👈 با کلیک قابل تغییر باشن
    },
  });
}
const reasonSwiper = document.querySelectorAll('.reason-swiper');
if (reasonSwiper.length > 0) {
  const carousel = new Swiper('.reason-swiper', {
    breakpoints: {
      320: {
        slidesPerView: 1.5
      },
    ...
    pagination: {
      el: '.reason-pagination', // 👈 عنصر مربوط به دایره‌ها
      clickable: true,          // 👈 با کلیک قابل تغییر باشن
    },
  });
}
const medalSwiper = document.querySelectorAll('.medal-swiper');
if (medalSwiper.length > 0) {
  const carousel = new Swiper('.medal-swiper', {
    breakpoints: {
      320: {
        slidesPerView: 2.5,
        spaceBetween: 30,
    ...
    pagination: {
      el: '.medal-pagination', // 👈 عنصر مربوط به دایره‌ها
      clickable: true,          // 👈 با کلیک قابل تغییر باشن
    },
  });
}
...
if (gallerySwiper.length > 0) {
  const carousel = new Swiper('.gallery-swiper', {
    breakpoints: {
      320: {
        slidesPerView:2,
        spaceBetween: 30,
    ...
    pagination: {
      el: '.swiper-pagination', // 👈 عنصر مربوط به دایره‌ها
      clickable: true,          // 👈 با کلیک قابل تغییر باشن
    },
  });
}
...
function handleCheckboxChange(checkbox) {
  ...
  if (checkbox.checked) {
      console.log("چک باکس تیک خورد");
  } else {
      console.log("چک باکس برداشته شد");
  }
}